...
import json
import os
from flask_restx import reqparse, Resource, Api, fields, Namespace
...
api = Namespace('message', description='message operation')
...
# parser.add_argument('Id',  required=False, help='message', location='args')
parser.add_argument('userId', required=True, help='id of user', location='args')
...
class Users(Resource):
    def __init__(self, Resource):
        self.api = api
    @api.doc(description='Get List of messages . \n\n ')
