...
def insert_first_reply(user_id):
    default_message = """Hello! I am ShoppingBot, an automated assistant to help you find the ideal product in this online shopping mall. How can I assist you today? Would you like me to summarize product reviews? You could also ask questions about reviews."""
